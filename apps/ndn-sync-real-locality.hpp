...
#ifndef NDN_RealGraphLocality_H
#define NDN_RealGraphLocality_H
 ...
 */
class RealGraphLocality : public App {
public:
  // register NS-3 type "RealGraphLocality"
  static TypeId
  GetTypeId();
  ...
  void
  DispatchRequest(ns3::IntegerValue val, bool pickNodeToSend = false);
